...
THIS AGREEMENT CONSTITUTES A LEGALLY BINDING CONTRACT BETWEEN YOU AND THE CLUB. BY ACCESSING, BROWSING, REGISTERING FOR, OR OTHERWISE USING THE PLATFORM, YOU ACKNOWLEDGE THAT YOU HAVE READ, UNDERSTOOD, AND AGREE TO BE BOUND BY THIS AGREEMENT, AS WELL AS ANY OTHER POLICIES, GUIDELINES, TERMS, OR DOCUMENTS INCORPORATED HEREIN BY REFERENCE.
...
This User Agreement ("Agreement") governs your access to and use of The Club platform, including all websites, applications, software, communications tools, artificial intelligence tools, databases, content, features, services, marketplaces, APIs, integrations, and related technologies made available by www.theclubnyc.com ("The Club," "we," "us," or "our").

For purposes of this Agreement, "Platform" means the entirety of The Club ecosystem and all related services, whether accessed through a website, mobile device, application, API, integration, email communication, messaging system, or any other means.

The Club operates a technology-enabled marketplace designed to facilitate introductions, discovery, communication, collaboration, and professional opportunities among individuals and organizations. These opportunities may include projects, internships, jobs, fellowships, advisory engagements, consulting engagements, research initiatives, workshops, temporary assignments, permanent employment opportunities, team formation activities, educational opportunities, and other forms of professional collaboration.

The Platform is intended primarily for business, educational, professional, and career-development purposes. The Club reserves the right to determine, in its sole discretion, whether a particular use of the Platform is consistent with its intended purposes.

2. THE ROLE OF THE CLUB

The Club is a technology platform and marketplace provider. The Club is not a party to agreements entered into between users and does not participate in negotiations, employment decisions, compensation decisions, project management, supervision, performance evaluation, disciplinary actions, termination decisions, or the delivery of services by users.

The Platform enables users to discover opportunities and connect with one another. However, The Club does not recruit, employ, supervise, direct, manage, evaluate, endorse, certify, guarantee, or otherwise control any user, opportunity, engagement, project, internship, job, employer, educational institution, or organization.

Nothing on the Platform shall be interpreted as creating an employment relationship, staffing relationship, recruiting relationship, agency relationship, joint venture, partnership, franchise relationship, fiduciary relationship, or other similar legal relationship between The Club and any user.

Users acknowledge and agree that The Club's role is limited to providing access to technology, information, communication tools, matching systems, recommendation engines, AI-powered features, marketplace functionality, and related services.
...
To access certain portions of the Platform, users may be required to create an account. By registering for an account, you represent and warrant that all information submitted to The Club is complete, accurate, current, and not misleading.
...
The Club reserves the right, in its sole discretion, to approve, reject, suspend, restrict, verify, investigate, or terminate any account at any time and for any lawful reason.

The Club may require identity verification, credential verification, educational verification, employment verification, business verification, payment verification, location verification, or other forms of authentication before permitting access to certain features of the Platform.

The failure of The Club to verify any information does not constitute a representation, warranty, certification, endorsement, or guarantee of accuracy.

4. USER REPRESENTATIONS AND WARRANTIES

By using the Platform, you represent and warrant that all information you provide to The Club or to other users is truthful, accurate, complete, and not misleading.
...
You acknowledge that The Club and other users may rely upon the information you provide and that material misrepresentations may result in suspension, termination, legal action, or other remedies available under applicable law.
...
Notwithstanding the foregoing, The Club shall not intentionally disclose confidential information submitted by users except as permitted by this Agreement, the Privacy Policy, applicable law, legal process, or the user's express authorization.
...
The Platform, including its software, technology, databases, algorithms, workflows, artificial intelligence systems, interfaces, designs, branding, trademarks, trade dress, logos, content, graphics, text, documentation, methodologies, and underlying intellectual property, is owned by The Club, its licensors, or its affiliates and is protected by intellectual property laws throughout the world.

Except as expressly authorized in writing by The Club, users may not reproduce, distribute, modify, create derivative works from, reverse engineer, scrape, extract, harvest, benchmark, frame, mirror, license, sublicense, sell, lease, assign, transfer, publish, or otherwise exploit any portion of the Platform.

Users further agree not to use the Platform to develop, train, benchmark, evaluate, improve, or support a competing product, service, marketplace, artificial intelligence model, database, matching engine, or business without The Club's prior written consent.

The Club reserves all rights not expressly granted under this Agreement.
"""
...
def build_page() -> str:
    ...
    shell = shell.replace("<title>Terms of Use | Qava</title>", "<title>User Agreement | The Club</title>")
    shell = shell.replace("<title>Terms of Use | The Club</title>", "<title>User Agreement | The Club</title>")
    shell = shell.replace(
        "  </style>\n</head>",
        f"{EXTRA_STYLES}\n  </style>\n</head>",
        1,
