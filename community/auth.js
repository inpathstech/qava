    ...
    if (state.loggedIn) {
      ...
      wrap.innerHTML =
        ...
        '<div class="community-auth-menu" id="communityAuthMenu" hidden>' +
          ...
          (state.premium ? '' : '<a class="community-auth-menu-item" href="https://app.theclubnyc.com/?premium=1"><span class="community-auth-menu-item-inner">' + iconMember + '<span>Upgrade to Premium</span></span></a>') +
          '<div class="community-auth-menu-divider" aria-hidden="true"></div>' +
      ...
      if (manageBtn) manageBtn.addEventListener('click', function () {
        ...
        if (window.qavaAuth && typeof window.qavaAuth.openSubscription === 'function') {
          ...
          window.location.href = 'https://app.theclubnyc.com/';
        }
      });
  ...
  function ensureModal() {
    ...
    modal.innerHTML =
      ...
      '<div class="community-auth-dialog" role="dialog" aria-modal="true" aria-labelledby="communityAuthTitle">' +
        ...
        '<p class="community-auth-foot">Not a member yet? <a href="https://app.theclubnyc.com/?premium=1">Join Premium</a></p>' +
      '</div>';
