        ...
        userFeedItem.innerHTML = `
          ...
          <div class="feed-inline-reply" data-feed-reply-thread="user">
            ...
            <div class="feed-inline-reply-field input-with-gate">
              ...
              <button type="button" class="feed-reply-send is-disabled" aria-label="Write a reply to send" aria-disabled="true"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z"/><path d="m21.854 2.147-10.94 10.939"/></svg></button>
            </div>
          </div>
        `;
